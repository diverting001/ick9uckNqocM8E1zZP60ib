<?php
final class weixin_payment_plugin_appljwxh5 extends ectools_payment_app implements ectools_interface_payment_app {
    ...
    public function __construct($app){
        parent::__construct($app);
         $this->notify_url = kernel::openapi_url('openapi.weixin', 'appljwxh5');
    ...
    public function setting(){
        ...
        return array(
            ...
            'redirect_url'=>array(
                'title'=>app::get('ectools')->_('支付完成跳转地址'),
                'type'=>'string',
                'validate_type' => 'required',
            ),
        );
    ...
    public function dopay($payment) {
        ...
        $redirect_url =   $this->getConf('redirect_url',__CLASS__);
        $data['appid'] = $appId;
        ...
        if($prepay_info['return_code']=='SUCCESS'){
            header('Location:'.$prepay_info['mweb_url'].'&redirect_url='.urlencode($redirect_url.'?order_id='.$payment['order_id']));
        } else {
