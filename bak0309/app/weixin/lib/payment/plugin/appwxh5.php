<?php
final class weixin_payment_plugin_appwxh5 extends ectools_payment_app implements ectools_interface_payment_app {
    ...
    public function __construct($app){
        parent::__construct($app);
         $this->notify_url = kernel::openapi_url('openapi.weixin', 'appwxh5');
