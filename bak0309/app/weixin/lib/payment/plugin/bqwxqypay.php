<?php
final class weixin_payment_plugin_bqwxqypay extends ectools_payment_app implements ectools_interface_payment_app {
     ...
     * @var string 支付方式key
     */
    public $app_key = 'bqwxqypay';
    /**
     * @var string 中心化统一的key
     */
    public $app_rpc_key = 'bqwxqypay';
    /**
     * @var string 统一显示的名称
     */
