...
'site.login_valide'=>array('type'=>SET_T_BOOL,'default'=>'false','desc'=>app::get('b2c')->_('会员登录需输入验证码')),//WZP
...
'site.member_price_display'=>array('type'=>SET_T_ENUM,'default'=>'1','desc'=>app::get('b2c')->_('会员价显示设定'),'options'=>array('1'=>app::get('b2c')->_('显示所有会员等级价格'),'2'=>app::get('b2c')->_('不显示会员价') )),//guzhengxiao
...
'site.show_storage'=>array('type'=>SET_T_ENUM,'default'=>'0','desc'=>app::get('b2c')->_('前台是否显示库存数量'),'options'=>array('1'=>app::get('b2c')->_('不显示库存提示'),'2'=>app::get('b2c')->_('显示库存数量提示'),'3'=>app::get('b2c')->_('启用库存优化方案') )),//guzhengxiao
...
'site.order.cancel.time'=>array('type'=>SET_T_STR,'default'=>'40','desc'=>app::get('b2c')->_('自动取消的时间'),'vtype'=>'required','helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('自动取消的时间，以分钟记')),//WZP

'site.order.2b.cancel.time'=>array('type'=>SET_T_STR,'default'=>'30','desc'=>app::get('b2c')->_('2B领取订单自动取消的时间'),'vtype'=>'required','helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('2B领取订单自动取消的时间，以天数记')),
);
