 ...
 * Time: 14:08
 */
final class wap_payment_plugin_megonghui extends ectools_payment_app implements ectools_interface_payment_app
{
    /**
     * @var string 支付方式名称
     */
    public $name = '渠道 怀谷智慧工会 支付';
    /**
     * @var string 支付方式接口名称
     */
    public $app_name = '渠道 怀谷智慧工会 支付';
    /**
     * @var string 支付方式key
     */
    public $app_key = 'megonghui';
    /**
     * @var string 中心化统一的key
     */
    public $app_rpc_key = 'megonghui';
    /**
     * @var string 统一显示的名称
     */
    public $display_name = '渠道 怀谷智慧工会 支付';
    /**
     * @var string 货币名称
     */
    public $curname = 'CNY';
    ...
    public function __construct($app){
        ...
        $this->notify_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_megonghui_server', 'callback');
        ...
        $this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_megonghui', 'callback');
    ...
    public function intro(){
        return app::get('ectools')->_('渠道 怀谷智慧工会 支付配置信息');
    }
    ...
    public function genSign($data){
        ...
        \Neigou\Logger::General('ecstore.megonghui.linkStr',array('action'=>'make sign','linkStr'=>$linkStr,'sign'=>md5($linkStr)));
        return md5($linkStr);
    }
...
eot;
    ...
    public function callback(&$recv) {
        if($this->is_return_vaild($recv)){
            ...
            $ret['status'] = 'invalid';
            \Neigou\Logger::General('ecstore.callback.megonghui',array('remark'=>'sign_err','data'=>$recv));
        }
        return $ret;
    }
