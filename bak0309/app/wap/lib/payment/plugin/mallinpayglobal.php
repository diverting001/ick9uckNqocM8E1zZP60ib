<?php
final class wap_payment_plugin_mallinpayglobal extends ectools_payment_app implements ectools_interface_payment_app {

    public $name = '通联支付';
    public $app_name = '通联支付';
    public $app_key = 'mallinpayglobal';
    public $app_rpc_key = 'mallinpayglobal';
    ...
    public function __construct($app){
        ...
        $this->notify_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_mallinpayglobal_server', 'callback');
        ...
        $this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_mallinpayglobal', 'callback');
...
//        $order_info = $_order -> getRow('*',array('order_id' => $payment['order_id']));
        ...
        \Neigou\Logger::General("tonglian.tonglian.req.global", array("data"=>json_encode($param)));
