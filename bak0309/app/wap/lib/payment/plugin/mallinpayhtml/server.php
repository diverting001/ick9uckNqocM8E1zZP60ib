...
class wap_payment_plugin_mallinpayhtml_server extends ectools_payment_app {
...
//        print_r($ret);die;
    ...
    private function verify($data, $sign) {
        ...
        $key = openssl_pkey_get_public(file_get_contents($this->getConf('cert_pub_path', 'wap_payment_plugin_mallinpayhtml')));
