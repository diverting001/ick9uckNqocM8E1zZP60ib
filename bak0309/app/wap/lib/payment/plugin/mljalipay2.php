...
final class wap_payment_plugin_mljalipay2 extends ectools_payment_app implements ectools_interface_payment_app {
    ...
    public function __construct($app){
        ...
        $this->notify_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_mljalipay2_server', 'callback');
        ...
        $this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_mljalipay2', 'callback');
    ...
    public function dopay($payment){
...

        {
            ...
            if($payment['is_certification']){
                ...
                \Neigou\Logger::General('ecstore.mljalipay2.global',array('remark'=>'支付宝身份校验参数','card_id'=>$payment['card_id'],'card_name'=>$payment['card_name'],'payment'=>$payment));
            }
...
//        }
        ...
        \Neigou\Logger::General("pay.mljalipay2", array("action"=>"dopaymljalipay2",
            'sparam1' => 'wap',
...
//            }
            $ret['status'] = 'succ';
            \Neigou\Logger::General('pay.mljalipay2', array('action' => 'callback_succ', 'data' => $recv));

        }else{
            $message = 'Invalid Sign';
            $ret['status'] = 'invalid';
            \Neigou\Logger::General('pay.mljalipay2', array('action' => 'sign_err', 'data' => $recv));
...
//--------------bin
    ...
    protected function sign($data, $signType = "RSA") {
        ...
        if ("RSA2" == $signType) {
            ...
            if(!$res){
                \Neigou\Logger::General('pay.mljalipay2', array('action' => 'sign_err', 'data' => json_encode($data)));
                return false;
