<?php
final class wap_payment_plugin_msdallinpay extends ectools_payment_app implements ectools_interface_payment_app {

    public $name = '山东邮政通联支付';
    public $app_name = '山东邮政通联支付';
    public $app_key = 'msdallinpay';
    public $app_rpc_key = 'msdallinpay';
    public $display_name = '山东邮政通联支付';
    public $curname = 'CNY';
    public $ver = '1.0';
    ...
    public function __construct($app){
        ...
        $this->notify_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_msdallinpay_server', 'callback');
        ...
        $this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_msdallinpay', 'callback');
    ...
    public function dopay($payment){
        ...
        $data['param']['productName'] = $this->strFilter($product_name);
        ...
        \Neigou\Logger::General("tonglian.sdtonglian.req", array("data"=>json_encode($param)));
    ...
    public function callback(&$recv){
        ...
        \Neigou\Logger::General("tonglian.sdtonglian", array("data"=>json_encode($recv)));
