 ...
 */
class wap_payment_plugin_mjuyoucps_server extends ectools_payment_app {
    ...
    public function callback(&$recv) {
        ...
        if(kernel::single('wap_payment_plugin_mjuyoucps')->is_return_vaild($recv)){
            ...
            echo 'fail';
            $ret['status'] = 'invalid';
            \Neigou\Logger::General('ecstore.notify.mjuyoucps',array('remark'=>'sign err','data'=>$recv));
        }
        return $ret;
    }
}