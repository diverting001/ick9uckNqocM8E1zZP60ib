 ...
 * 武传斌
 */
final class wap_payment_plugin_mallinpayglobalhtml extends ectools_payment_app implements ectools_interface_payment_app {

    public $name = '通联h5国际支付';
    public $app_name = '通联h5国际支付';
    public $app_key = 'mallinpayglobalhtml';
    public $app_rpc_key = 'mallinpayglobalhtml';
    public $display_name = '通联h5国际支付';
    public $curname = 'CNY';
    public $ver = '2.0';
    ...
    public function __construct($app){
        ...
        $this->notify_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_mallinpayglobalhtml_server', 'callback');
        ...
        $this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_mallinpayglobalhtml', 'callback');
...
//        $recv1["signMsg"] = $recv['signMsg'];
        ...
        \Neigou\Logger::General('ecstore.ectools.mallinpayglobalhtml',
            array(
                "pay_method"=>"mallinpayglobalhtml1",
