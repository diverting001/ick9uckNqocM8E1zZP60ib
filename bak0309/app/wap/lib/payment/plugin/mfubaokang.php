 ...
 * Time: 14:08
 */
final class wap_payment_plugin_mfubaokang extends ectools_payment_app implements ectools_interface_payment_app
{
    /**
     * @var string 支付方式名称
     */
    public $name = '渠道 福保康 支付';
    /**
     * @var string 支付方式接口名称
     */
    public $app_name = '渠道 福保康 支付';
    /**
     * @var string 支付方式key
     */
    public $app_key = 'mfubaokang';
    /**
     * @var string 中心化统一的key
     */
    public $app_rpc_key = 'mfubaokang';
    /**
     * @var string 统一显示的名称
     */
    public $display_name = '渠道 福保康 支付';
    /**
     * @var string 货币名称
     */
    public $curname = 'CNY';
    ...
    public function __construct($app){
        ...
        $this->notify_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_mfubaokang_server', 'callback');
        ...
        $this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_mfubaokang', 'callback');
    ...
    public function setting(){
        return array(
            ...
            'mer_id'=>array(
                'title'=>app::get('ectools')->_('商户号 福保康提供'),
                'type'=>'string',
                'validate_type' => 'required',
            ),
            'salt'=>array(
            ...
            'refund_query_url'=>array(
                'title'=>app::get('ectools')->_('退款查询提交URL'),
                'type'=>'string',
                'validate_type' => 'required',
            ),
            'order_by' =>array(
    ...
    public function intro(){
        return app::get('ectools')->_('渠道 福保康 支付配置信息');
    }
    ...
    public function genSign($data){
        ...
        \Neigou\Logger::General('ecstore.mfubaokang.linkStr',array('action'=>'make sign','linkStr'=>$linkStr,'sign'=>md5($linkStr)));
        return md5($linkStr);
    }
...
eot;
    ...
    public function callback(&$recv) {
        if($this->is_return_vaild($recv)){
            ...
            $ret['pay_app_id'] = "mfubaokang";
            $ret['pay_type'] = 'online';
            $ret['status'] = 'succ';
        }else{
            $ret['status'] = 'invalid';
            \Neigou\Logger::General('ecstore.callback.mfubaokang',array('remark'=>'sign_err','data'=>$recv));
        }
        return $ret;
    }
