 ...
 * Time: 11:12
 */
final class wap_payment_plugin_mqwomai extends ectools_payment_app implements ectools_interface_payment_app
{
    /**
     * @var string 支付方式名称
     */
    public $name = '中粮企业购 支付';
    /**
     * @var string 支付方式接口名称
     */
    public $app_name = '中粮企业购 支付';
    /**
     * @var string 支付方式key
     */
    public $app_key = 'mqwomai';
    /**
     * @var string 中心化统一的key
     */
    public $app_rpc_key = 'mqwomai';
    /**
     * @var string 统一显示的名称
     */
    public $display_name = '中粮企业购 支付';
    /**
     * @var string 货币名称
     */
    public $curname = 'CNY';
    ...
    public function __construct($app){
        ...
        $this->notify_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_mqwomai_server', 'callback');
        ...
        $this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_mqwomai', 'callback');
    ...
    public function dopay($payment) {
        ...
        if($sdf['status']=='succ'){
            ...
            \Neigou\Logger::General('pay.mqwomai', array('action' => 'pay succ 302'));
        ...
        $this->add_field('orderSource', $this->getConf('order_source',__CLASS__));//渠道标识
        ...
        if(isset($response['data']['mweburl']) && $response['msg'] = '成功'){
            ...
            \Neigou\Logger::General('ecstore.mqwomai.do_pay', array('action' => 'pay_fail', 'result' => $response));
    ...
    public function genSign($data){
        ...
        \Neigou\Logger::General('ecstore.mqwomai.linkStr',array('action'=>'make sign','linkStr'=>$linkStr,'sign'=>md5($linkStr)));
    ...
    public function request($api = '', $post_data = array()) {
        ...
        \Neigou\Logger::General('ecstore.mqwomai.req', array('action' => 'do req','req_url'=>$api,'post_data'=>$post_data,'response_data'=>$result));
