 ...
 * Time: 11:12
 */
final class wap_payment_plugin_mguangquan extends ectools_payment_app implements ectools_interface_payment_app
{
    /**
     * @var string 支付方式名称
     */
     ...
     * @var string 支付方式接口名称
     */
    public $app_name = '光圈 福享支付';
    /**
     * @var string 支付方式key
     */
    public $app_key = 'mguangquan';
    /**
     * @var string 中心化统一的key
     */
    public $app_rpc_key = 'mguangquan';
    /**
     * @var string 统一显示的名称
     */
    public $display_name = '光圈 福享支付';
    /**
     * @var string 货币名称
     */
    public $curname = 'CNY';
    ...
    public function __construct($app){
        ...
        $this->notify_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_mguangquan_server', 'callback');
        ...
        $this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_mguangquan', 'callback');
    ...
    public function intro(){
        return app::get('ectools')->_('光圈 福享支付 使用内购支付宝 malipay2 参数');
    }
...
EOF;
    ...
    public function sign($data,$signType='RSA'){
        ...
        if ("RSA2" == $signType) {
            ...
            if(!$res){
                \Neigou\Logger::General('ecstore.pay.mguangquan', array('action' => 'sign_err', 'data' => json_encode($data)));
                return false;
            }
        } else {
