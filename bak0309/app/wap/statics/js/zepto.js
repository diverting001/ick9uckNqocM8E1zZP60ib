    ...
    $.fn.serializeArray = function() {
        var result = [],
            ...
            $([].slice.call(this.get(0).elements)).each(function() {
                ...
                if (this.nodeName.toLowerCase() != 'fieldset' && !this.disabled && this.name && this.value && type != 'submit' && type != 'reset' && type != 'button' && ((type != 'radio' && type != 'checkbox') || this.checked)) result.push({
                    name: el.attr('name'),
                    value: el.val()
                })
            })
