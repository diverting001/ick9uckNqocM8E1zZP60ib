...
var DropMenu=new Class({
    ...
    initialize:function(el,options){
        ...
        this.menu=$(menu)||this.element.getParent().getElement('.'+menu);
        if(!this.menu)return;
...
/**
 * Created by Lichangshu on 14-3-24.
 */
function backtotopEvent(obj,ev,fn){
    if(obj.attachEvent){
...
backtotopEvent(window,'load',function(){
    var oRTT=document.getElementById('topsidepannel');
    if (!oRTT) {
        return;
    }
