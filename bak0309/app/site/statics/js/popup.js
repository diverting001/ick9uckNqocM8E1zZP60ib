...
var Popup = new Class({
    ...
    build: function(template, target) {
        ...
        template = '<div class="{container}" {id} data-single="'+ !!options.single +'"  >' + this.getTemplate(template) + '</div>';
...
var Dialog = new Class({
    ...
    alert: function() {
        ...
        var html = '<div class="pop-attention-main"><div class="figure"><dfn class="alert">!</dfn><span class="mark">' + args.msg + '</span></div><div class="bottom"><a href="javascript:void(0);" class="btn btn-caution action-confirm">' + (options.confirmText || '确定') + '</a> </div></div>';
    ...
    tips: function() {
        ...
        var html = '<span class="icon">&#x24;</span><p>' + args.msg + '</p><div class="bottom"><a href="javascript:void(0);" class="btn btn-black btn-small action-confirm" data-return="1">' + (options.confirmText || '确定') + '</a><a  class="btn btn-cancel btn-small action-cancel" href="javascript:void(0);" data-return="0">' + (options.cancelText || '取消') + '</a></div>';
        Dialog.instance(new Element('div', {html: html}), Object.merge({
            width: '',
            modal: false,
            template: template,
...
MooDialog.Alert = new Class({
    ...
    initialize: function(msg, options){
        ...
        var okButton = new Element('button.confirm-button', {
            events: {
        ...
        $$('.confirm-button').addEvent('click',function(event){
