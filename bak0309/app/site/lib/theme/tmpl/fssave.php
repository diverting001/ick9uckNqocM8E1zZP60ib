...
class site_theme_tmpl_fssave 
{
    ...
    private function __get_tmpl_list() {
        $ctl = array(
			...
			'share'=>app::get('site')->_('我的LEHO页面'),
            'designer'=>app::get('site')->_('设计师聚合页'),
            'designerShow'=>app::get('site')->_('设计师详情页'),            
            'topic'=>app::get('site')->_('专题页'),
            'topicShow'=>app::get('site')->_('专题详情页'),
            'indorser'=>app::get('site')->_('背书人'),            
