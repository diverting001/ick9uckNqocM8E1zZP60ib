...
class site_controller extends base_controller
{
     ...
     * @var array
     */
    public $exclude_css_by_template = array(
        'site/product/shopdeals.html',
        'site/product/shopdetail.html',
        'site/product/deals.html',
...
/*        $to = array(
    ...
    final public function display_tmpl($tmpl, $fetch=false,$is_preview=false)
    {
        ...
        logger::log("###########display_tmpl:".$tmpl_content, LOG_SYS_DEBUG);
    ...
    final public function page($view, $no_theme=false, $app_id=null)
    {
        ...
        if(!in_array($origin_view,$this->exclude_css_by_template))
        {
     ...
     * @return void
     */
    public function splash($status='success', $url='', $msg=null, $ajax=false, $data=null,$jsonp=''){
...
//        $msg = $msg.json_encode(debug_backtrace());
