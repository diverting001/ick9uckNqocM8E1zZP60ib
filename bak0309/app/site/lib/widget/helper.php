...
class site_widget_helper
{
    function function_header(){
        ...
        if($debug_js){
            ...
            $ret.= '<script src="'.$path.'/js_mini/mootools.js'.$jsver.'"></script>
            <script src="'.$path.'/js_mini/moomore.js'.$jsver.'"></script>
            <script src="'.$path.'/js_mini/jstools.js'.$jsver.'"></script>
            <script src="'.$path.'/js_mini/switchable.js'.$jsver.'"></script>
            <script src="'.$path.'/js_mini/dragdropplus.js'.$jsver.'"></script>
            <script src="'.$path.'/js_mini/widgetsinstance.js'.$jsver.'"></script>';
        }
