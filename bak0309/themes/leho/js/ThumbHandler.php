...
class ThumbHandler {
        ...
        // 文件类型定义,并指出了输出图片的函数
        var $all_type = array ("jpg" => array ("output" => "imagejpeg" , "content_type"=>'image/jpeg'), "gif" => array ("output" => "imagegif" , "content_type"=>'image/gif' ), "png" => array ("output" => "imagepng" , "content_type"=>'image/png' ), "wbmp" => array ("output" => "image2wbmp" ), "jpeg" => array ("output" => "imagejpeg" , "content_type"=>'image/jpeg' ) );
        ...
        function _output() {
				...
				$content_type = $this->all_type [$img_type] ['content_type'];
                if (function_exists ( $func_name )) {
						...
						if ($func_name=='imagejpeg'||$func_name=='image2wbmp')
		...
		* @return boolean
		*/
		function flip($degrees = 90)
		{
			$this->h_src = @imagerotate($this->h_src, $degrees,0);
		}
}