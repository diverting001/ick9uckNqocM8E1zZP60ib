...
class wxauth {
	function __construct(){
		define('WX_APPID', 'wxd1e5a08e27a2ca1c');//yes!
		define('WX_SECRET', '2726339fc4bdbd3814b54f951ca465b5');
	...
	function gettoken(){
		...
		$data['redirect_uri'] =  'http://' . $host . '/plugin/wxfuliauth.php?act=getopenid';
		$data['state'] = 123;
